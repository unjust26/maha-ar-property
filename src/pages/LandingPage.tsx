      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-zinc-950/80 backdrop-blur-xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 text-sm">
            <a href="#properties" className="text-zinc-400 hover:text-white transition-colors">Properties</a>
            <a href="#features" className="text-zinc-400 hover:text-white transition-colors">Features</a>
            <a href="/login" className="px-4 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white text-sm transition-colors">Sign In</a>
          </div>
        </div>
      </nav>
